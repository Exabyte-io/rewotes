...
export const Toolbar: FC<{ setInput: (value: SetStateAction<CrystalInput>) => void }> = ({ setInput }) => {
  ...
  return (
    <div className="focus-within:border fous-within:border-accent absolute top-0 z-30 flex h-20 max-h-20 w-full flex-row items-center justify-between gap-5 bg-dark2 px-10 lg:px-20">
