...
class Downloader(object):
    def __init__(self, destination_filename, api_key):
        ...
        if destination_filename[-16:] != ".materialarchive":
            raise ValueError("Expected file extension materialarchive. Found filename: " + destination_filename)
            ...
            for material_ids_slice_index in range(0, len(material_ids), 1000):
                ...
                for document in docs:
                    ...
                    for atomic_number in range(1,119):
                        material.composition[atomic_number] = int(document.composition[atomic_number])
                        material.composition_reduced[atomic_number] = int(document.composition_reduced[atomic_number])
